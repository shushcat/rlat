...
Rlat has (or has in development) some features that make it suitable for studies involving large corpora in which there are spelling variations:
- a word stemmer using the ([Snowball language](https://snowballstem.org)) to remove spelling differences and emphasize word senses, 
- support for [stop word](https://en.wikipedia.org/wiki/Stop_words) lists for filtering words, 
- matching of words within a specified [edit distance](https://en.wikipedia.org/wiki/Edit_distance) using [a modified Levenshtein distance algorithm](https://github.com/GlobalNamesArchitecture/damerau-levenshtein).
...
- Comparator density
    ...
    - [ ] Add a density function like that used by [Neidorf 2019](https://www.nature.com/articles/s41562-019-0570-1), returning ratios of matching characters to overall character numbers.
- Prospective:
...
An earlier, less capable version of this program is available at [the Rcopyfind repository](https://github.com/shushcat/rcopyfind_prototype) repository.
